console.log("Tes")
fetch("http://192.168.17.132:3030/api/read")
...
async function postAPI() {
    ...
    await fetch("http://192.168.17.132:3030/api/create", {
        method: "POST",
...
async function getIdAPI(idValue) {
    ...
    try {
        const notes = await fetch("http://192.168.17.132:3030/api/getId", {
            method: "POST",
            body: JSON.stringify(obj),
            headers: {
                'Accept': 'application/json',
...
async function updateAPI(idNote) {
    ...
    await fetch("http://192.168.17.132:3030/api/update", {
        method: "PUT",
        body: JSON.stringify(obj),
        headers: {
            'Accept': 'application/json',
...
async function deleteAPI(idNote) {
    ...
    await fetch("http://192.168.17.132:3030/api/delete", {
        method: "DELETE",
        body: JSON.stringify(obj),
        headers: {
            'Accept': 'application/json',
